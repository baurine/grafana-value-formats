...
export const getCategories = (): ValueFormatCategory[] => [
  ...
  },
  {
    ...
    formats: [
      { name: 'packets/sec', id: 'decpps', fn: decimalSIPrefix('pps') },
      { name: 'bits/sec', id: 'decbps', fn: decimalSIPrefix('bps') },
      { name: 'bytes/sec', id: 'decBps', fn: decimalSIPrefix('Bs') },
      { name: 'kilobytes/sec', id: 'decKBs', fn: decimalSIPrefix('Bs', 1) },
      { name: 'kilobits/sec', id: 'decKbits', fn: decimalSIPrefix('bps', 1) },
      { name: 'megabytes/sec', id: 'decMBs', fn: decimalSIPrefix('Bs', 2) },
      { name: 'megabits/sec', id: 'decMbits', fn: decimalSIPrefix('bps', 2) },
      { name: 'gigabytes/sec', id: 'decGBs', fn: decimalSIPrefix('Bs', 3) },
      { name: 'gigabits/sec', id: 'decGbits', fn: decimalSIPrefix('bps', 3) },
      { name: 'terabytes/sec', id: 'decTBs', fn: decimalSIPrefix('Bs', 4) },
      { name: 'terabits/sec', id: 'decTbits', fn: decimalSIPrefix('bps', 4) },
      { name: 'petabytes/sec', id: 'decPBs', fn: decimalSIPrefix('Bs', 5) },
      { name: 'petabits/sec', id: 'decPbits', fn: decimalSIPrefix('bps', 5) },
    ],
  },
  {
    name: 'Data Rate (IEC)',
    formats: [
      { name: 'packets/sec', id: 'pps', fn: binarySIPrefix('pps') },
      { name: 'bits/sec', id: 'bps', fn: binarySIPrefix('bps') },
      { name: 'bytes/sec', id: 'Bps', fn: binarySIPrefix('Bs') },
      { name: 'kilobytes/sec', id: 'KBs', fn: binarySIPrefix('Bs', 1) },
      { name: 'kilobits/sec', id: 'Kbits', fn: binarySIPrefix('bps', 1) },
      { name: 'megabytes/sec', id: 'MBs', fn: binarySIPrefix('Bs', 2) },
      { name: 'megabits/sec', id: 'Mbits', fn: binarySIPrefix('bps', 2) },
      { name: 'gigabytes/sec', id: 'GBs', fn: binarySIPrefix('Bs', 3) },
      { name: 'gigabits/sec', id: 'Gbits', fn: binarySIPrefix('bps', 3) },
      { name: 'terabytes/sec', id: 'TBs', fn: binarySIPrefix('Bs', 4) },
      { name: 'terabits/sec', id: 'Tbits', fn: binarySIPrefix('bps', 4) },
      { name: 'petabytes/sec', id: 'PBs', fn: binarySIPrefix('Bs', 5) },
      { name: 'petabits/sec', id: 'Pbits', fn: binarySIPrefix('bps', 5) },
    ],
  },
  {
    name: 'Date & Time',
