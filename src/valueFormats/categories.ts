...
export const getCategories = (): ValueFormatCategory[] => [
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'kibibytes/sec', id: 'KBs', fn: binarySIPrefix('Bs', 1) },
      { name: 'kibibits/sec', id: 'Kbits', fn: binarySIPrefix('bps', 1) },
      { name: 'mebibytes/sec', id: 'MBs', fn: binarySIPrefix('Bs', 2) },
      { name: 'mebibits/sec', id: 'Mbits', fn: binarySIPrefix('bps', 2) },
      { name: 'gibibytes/sec', id: 'GBs', fn: binarySIPrefix('Bs', 3) },
      { name: 'gibibits/sec', id: 'Gbits', fn: binarySIPrefix('bps', 3) },
      { name: 'tebibytes/sec', id: 'TBs', fn: binarySIPrefix('Bs', 4) },
      { name: 'tebibits/sec', id: 'Tbits', fn: binarySIPrefix('bps', 4) },
      { name: 'pebibytes/sec', id: 'PBs', fn: binarySIPrefix('Bs', 5) },
      { name: 'pebibits/sec', id: 'Pbits', fn: binarySIPrefix('bps', 5) },
    ],
  },
  {
    name: 'Date & Time',
